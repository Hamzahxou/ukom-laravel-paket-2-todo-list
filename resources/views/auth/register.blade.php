<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Name -->
        <div>
            <x-input-label for="name" class="text-xs" :value="__('Name')" />
        ...
        <div class="mt-2">
            <x-primary-button class="block w-full">
                <div class="text-center w-full">Register</div>
            </x-primary-button>
        </div>
        ...
        <div class="mt-2">
            <a href="{{ route('oauth.google.redirect') }}"
                class="flex gap-2 items-center justify-center w-full px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-25 transition ease-in-out duration-150">
