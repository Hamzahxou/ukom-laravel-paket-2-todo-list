<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div>
            ...
            <x-text-input id="email" class="block text-sm mt-1 w-full" type="email" name="email" :value="old('email')"
        ...
        <div class="mt-2">
            ...
            <x-text-input id="password" class="block text-sm mt-1 w-full" type="password" name="password" required
        ...
        <div class="mt-2">
            <x-primary-button class="block w-full">
                <div class="text-center w-full">{{ __('Log in') }}</div>
            </x-primary-button>
        </div>
        ...
        <div class="flex items-center mt-3">
            ...
            <p class="mx-4 text-gray-500 text-xs">or</p>
            <hr class="flex-1 border-t border-gray-300">
        </div>
        <div class="mt-2">
            <a href="{{ route('oauth.google.redirect') }}"
                class="flex gap-1 items-center justify-center w-full px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-25 transition ease-in-out duration-150">
