<script>
    function updateComment(url, content) {
        ...
        swalWithTailwindButtons.fire({
            ...
            html: `
                <textarea id="swal-input1" class="block w-full text-gray-800 bg-transparent font-bold text-sm mb-2 p-2 border rounded-md" placeholder="Comment..." style="field-sizing: content;max-height: 200px;">${content}</textarea>
            `,
            focusConfirm: false,
